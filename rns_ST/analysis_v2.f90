subroutine mass_radius
  ...
  real(8) :: gama_equator,rho_equator,ww_equator, sphi_equator, &
            gama_pole, rho_pole
  real(8) :: J
  real(8), dimension(MDIV) :: Intm, scal, Vphi, Acoup
  ...
  real(8), dimension(SDIV) :: gama_mu_0, rho_mu_0, ww_mu_0, sphi_mu_0
  real(8), dimension(SDIV) :: gama_mu_1, rho_mu_1
  ...
  r_circ = sqrt(kappa) * r_e * exp((gama_equator-rho_equator)/2.0) * exp(-sphi_equator**2 * B_coup / 4.d0 )
