...
#include "option_macro.h"
  ...
  real(8), allocatable, dimension(:) :: gama_mu_1,gama_mu_0,rho_mu_1,rho_mu_0,ww_mu_0
  real(8), allocatable, dimension(:,:) :: da_dm,dgds,dgdm
  real(8), allocatable, dimension(:,:) :: S_metric_rho, S_metric_gama, S_metric_omega
  real(8), allocatable, dimension(:,:) :: D1_metric_rho, D1_metric_gama, D1_metric_omega
  real(8), allocatable, dimension(:,:) :: D2_metric_rho, D2_metric_gama, D2_metric_omega
  character(8) :: fil1, fil2

  allocate(gama_mu_1(SDIV), gama_mu_0(SDIV), rho_mu_1(SDIV), rho_mu_0(SDIV), ww_mu_0(SDIV))
  allocate(da_dm(SDIV,MDIV), dgds(SDIV,MDIV), dgdm(SDIV,MDIV))
  allocate(S_metric_rho(SDIV,MDIV), S_metric_gama(SDIV,MDIV), S_metric_omega(SDIV,MDIV))
  allocate(D1_metric_rho(LMAX+1,SDIV), D1_metric_gama(LMAX+1,SDIV), D1_metric_omega(LMAX+1,SDIV))
  allocate(D2_metric_rho(SDIV,LMAX+1), D2_metric_gama(SDIV,LMAX+1), D2_metric_omega(SDIV,LMAX+1))
...
! --- End of iteration 
  ...
  deallocate(gama_mu_1,gama_mu_0,rho_mu_1,rho_mu_0,ww_mu_0,da_dm,dgds,dgdm)
  deallocate(S_metric_rho, S_metric_gama, S_metric_omega, D1_metric_rho, D1_metric_gama, D1_metric_omega)
  deallocate(D2_metric_rho, D2_metric_gama, D2_metric_omega)
