module para_mod
  ...
  real(8), parameter :: M_goal = 2.d0
  real(8) :: Mb_goal= 1.6d0
  real(8), parameter :: J_goal = .9d0
  real(8), parameter :: chi_goal = 0.63d0
  real(8), parameter :: omc_goal = 30.d0 ! Hz

  ! for const-j law
  real(8), parameter :: A_diff = 10.d0
  ! for Uryu law
  ...
  real(8), parameter :: parA = 1.d0 ! the smaller, the more differential
  real(8), parameter :: parB = 1.d0 ! the greater, the more differential
  ...
  integer, parameter :: res  = 300 ! 200 should be minimal for scientific run

  integer, parameter :: s_pwr = 1
  real(8), parameter :: SMAX = 1.d0 - 1.d-1**(9.d0/s_pwr)
  ...
  ! disk quantities
  real(8), parameter :: edge_in = 800.d0 ! [r_e]
  real(8), parameter :: s_inner = edge_in**(1.d0/dble(s_pwr)) / (edge_in**(1.d0/dble(s_pwr)) + 1.d0)
  real(8) :: j_disk = 4.5d0 ! lower gives rise to closer outer edge
  real(8) :: p_max_disk, h_max_disk
  ...
  real(8), parameter :: f_uni = 2.029739818539300e+05
  real(8), parameter :: l_uni = 1.4769994423016508
